...
当然比赛过程中打一局完整的麻将是不现实的，你只需要判断一副手牌是否和牌即可。
...
\begin{remark}
	...
	\hspace{0.15cm} \textbf{雀头}：两张同花色的牌，如 \includegraphics[scale=0.5]{mahjong/1s.png} \includegraphics[scale=0.5]{mahjong/1s.png}
	
    \hspace{0.15cm} \textbf{面子}：包括 \textbf{刻子} 和 \textbf{顺子} (不要问为啥没杠，莫抬杠)

    \begin{itemize}
        \item \textbf{刻子}：三张同花色的牌，如 \includegraphics[scale=0.5]{mahjong/1m.png} \includegraphics[scale=0.5]{mahjong/1m.png} \includegraphics[scale=0.5]{mahjong/1m.png}。
        \item \textbf{顺子}：三张相邻的同类型牌（只包括条/索、饼/筒、万三种），如 \includegraphics[scale=0.5]{mahjong/1m.png} \includegraphics[scale=0.5]{mahjong/2m.png} \includegraphics[scale=0.5]{mahjong/3m.png}。\includegraphics[scale=0.5]{mahjong/9m.png} 与\includegraphics[scale=0.5]{mahjong/1m.png}、\includegraphics[scale=0.5]{mahjong/9p.png} 与\includegraphics[scale=0.5]{mahjong/1p.png}、\includegraphics[scale=0.5]{mahjong/9s.png} 与\includegraphics[scale=0.5]{mahjong/1s.png} 不算作相邻
    \end{itemize}
...
\begin{itemize}
	\item 一个$1 \sim 9$的数字$x+$一个小写字母$b$，代表$x$饼（也叫$x$筒）。例如$2b$代表 \includegraphics[scale=0.5]{mahjong/2p.png}。
	\item 一个$1 \sim 9$的数字$x+$一个小写字母$t$，代表$x$条（也叫$x$索）。例如$8t$代表 \includegraphics[scale=0.5]{mahjong/8s.png}。
	\item 一个$1 \sim 9$的数字$x+$一个小写字母$w$，代表$x$万。例如$5w$代表 \includegraphics[scale=0.5]{mahjong/5m.png}。
	\item 一个$1 \sim 7$的数字$x+$一个小写字母$z$，从$1z \sim 7z$分别代表 \includegraphics[scale=0.5]{mahjong/1z.png}、\includegraphics[scale=0.5]{mahjong/2z.png}、\includegraphics[scale=0.5]{mahjong/3z.png}、\includegraphics[scale=0.5]{mahjong/4z.png}、\includegraphics[scale=0.5]{mahjong/5z.png}、\includegraphics[scale=0.5]{mahjong/6z.png}、\includegraphics[scale=0.5]{mahjong/7z.png}。
\end{itemize}
...
\begin{tabularx}{450pt}{X|X}
	...
	\midrule
    5 & Waiting for Tsumo!\\
    1w 2w 3w 4b 5b 6b 7t 8t 9t 1b 1b 1z 2z 6z & Waiting for Tsumo!\\
    1w 2w 3w 4b 5b 6b 7t 8t 9t 1b 1b 2z 2z 6z & Tsumo!\\
    1w 2w 3w 4b 5b 6b 7t 8t 9t 1b 1b 2z 2z 2z & Waiting for Tsumo!\\
    1b 2b 3b 4b 5b 6b 2t 4t 5t 5t 5t 6t 7t 8t & Waiting for Tsumo!\\
    1b 1b 1b 2b 3b 4b 5b 6b 7b 8b 9b 9b 9b 1t &\\
	\bottomrule
\end{tabularx}
