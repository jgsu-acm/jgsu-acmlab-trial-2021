...
\section*{做法}
签到题，题意即求出$\lfloor A \times (1-p_1\%) \times (85\%)^0 \rfloor + \lfloor A \times (1-p_2\%) \times (85\%)^1 \rfloor + \lfloor A \times (1-p_3\%) \times (85\%)^2 \rfloor + \lfloor A \times (1-p_4\%) \times (85\%)^3 \rfloor$的值
